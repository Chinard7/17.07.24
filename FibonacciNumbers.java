...
public class FibonacciNumbers extends JFrame 
{
   ...
   public FibonacciNumbers()
   {
      ...
      //parte que foi modificada pelo aluno//
...
previousNumberJButton.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent event) {
        if (count > 1) { // Garante que não estamos abaixo do primeiro número Fibonacci
            long temp = n2 - n1;
            n2 = n1;
            n1 = temp;
            count--;
      ...
      setSize(400, 200);
      setVisible(true);
   } // final da parte modificada pelo aluno para adicionar o previous buttom
